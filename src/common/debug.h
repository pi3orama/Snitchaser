...
__debug_component_levels[NR_DEBUG_COMPONENTS] = {
	...
	[REPLAYER_HOST]	= DBG_LV_TRACE,
	[REPLAYER_TARGET]	= DBG_LV_TRACE,
...
__debug_component_levels[NR_DEBUG_COMPONENTS] = {
	...
	[COMPRESS]			= DBG_LV_VERBOSE,
	[SIGNAL]			= DBG_LV_VERBOSE,
	[REPLAYER_HOST]		= DBG_LV_VERBOSE,
	[REPLAYER_TARGET]	= DBG_LV_VERBOSE,
	[PTRACE]			= DBG_LV_VERBOSE,
	[PROCMAPS]			= DBG_LV_VERBOSE,
	[ELF]				= DBG_LV_VERBOSE,
	[LOG_SYSCALL]		= DBG_LV_VERBOSE,
	[XGDBSERVER]		= DBG_LV_VERBOSE,
};
